...
Bildirim tercihleri, bildirim kutusu, okundu/silme akislari ve Expo push token kaydi uygulama tarafinda hazir. Gercek cihazda push token icin EAS `projectId` ayarlanmalidir.
